...
using Moq;
using Ragnar.Mock.Interest.Calculator.Contract;
using Ragnar.Mock.Interest.Calculator.Helpers;
using Ragnar.Mock.Interest.Model;
using Ragnar.Mock.Interest.Repository;
using System;

namespace Ragnar.Mock.UnitTesting.Interest.Calculator
{
    [TestClass]
    public class InterestCalculatorTest
    {
        ...
        private Mock.Interest.Calculator.InterestCalculator interestCalculator;
        ...
        public void TestInitialize()
        {
            ...
            interestCalculator = new Mock.Interest.Calculator.InterestCalculator(
        ...
        public void ProjectDepositSummary_ApplyInterestRateOnly_ReturnProjectedSummary()
        {
            ...
            interestHelperMock.Setup(x => x.Interest(It.IsAny<decimal>(), 0M)).Returns(new Mock.Interest.Calculator.Contract.Interest() { AsGross = 3M, AsNet = 3M });
        ...
        public void ProjectDepositSummary_ApplyInterestRateAndTaxIfEqual_ReturnProjectedSummary()
        {
            ...
            interestHelperMock.Setup(x => x.Interest(It.IsAny<decimal>(), 0.16M)).Returns(new Mock.Interest.Calculator.Contract.Interest() { AsGross = 14400M, AsNet = 12096M });
